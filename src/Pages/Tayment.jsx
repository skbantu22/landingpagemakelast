...
function Tayment() {
  ...
  }, [name, address, phone, quantity, total]);
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // Save full order details in localStorage
      const orderDetails = {
        _id: savedOrder._id,
      ...
      // --- HERE: Send server-side event to Facebook ---
    try {
      await fetch("http://localhost:5000/api/meta/send-event", {
        method: "POST",
        headers: { "Content-Type": "application/json" },
        body: JSON.stringify({
          name,
          ...
          address,
           quantity,
            total,
          testEventCode: "TEST47006", // your unique test code from Meta
        }),
      });
      ...
      if (window.fbq) {
  const numericTotal = Number(total); // convert to number just in case
  if (!isNaN(numericTotal)) {
    ...
    console.warn("Invalid total value for Meta Pixel Purchase event");
  }
}
            ...
            >
              ...
              <div>
                ...
                <input
                  ...
                  type="text"
                  placeholder="আপনার ঠিকানা লিখুন (ঐচ্ছিক)"
                  name="street-address"
...
<h2 className="mb-6 text-xl font-bold text-gray-800">
          ...
          <div className="p-4 mt-6 bg-gray-50 rounded-lg border border-gray-200">
            ...
            <p className="text-sm text-gray-600">
              ডেলিভারী চার্জ: ফ্রি হোম ডেলিভারী
            </p>
          </div>
        ...
        {/* RIGHT SECTION */}
        <div>
          <div className="hidden lg:mt-9 lg:flex items-start p-4 mb-4 rounded-lg bg-gray-50 border border-gray-200">
            <div className="flex flex-col sm:flex-row sm:items-center w-full">
              ...
              <div className="flex-grow">
                <p className="text-base text-gray-800 leading-snug">
                  ...
                  <span className="text-xl font-bold ml-1 text-gray-600">
                    ×{quantity}
                  </span>
                </p>
